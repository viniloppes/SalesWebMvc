...
namespace SalesWebMvc.Controllers
{
    public class SellersController : Controller
    {
        ...
        public async Task<IActionResult>  Delete(int id)
        {
            ...
            {
                return RedirectToAction(nameof(Error), new { messagem = ex.Message });
        ...
        public async Task<IActionResult>  Details(int? id)
        {
            if (id == null)
            {
                return RedirectToAction(nameof(Error), new { messagem = "Id not provided" });
            ...
            if (obj == null)
            {
                return RedirectToAction(nameof(Error), new { messagem = "Id not found" });
            }
            return View(obj);
        }
        ...
        public async Task<IActionResult>  Edit(int id, Seller seller)
        {
            ...
            if (id != seller.Id)
            {
                return RedirectToAction(nameof(Error), new { messagem = "Id missmatch" });
            }
            try
            {
